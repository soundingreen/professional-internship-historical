# -*- coding: utf-8 -*-
"""
Created on Mon Dec  6 15:05:05 2021
...
directory=actual+f"/Raw_sk&k_plots/exp{exp_id}"
print(directory)
try:
...
for ch in electrodes[1]:
    ...
    ax.set_title(f'Skewness and Excess Kurtosis of the electrode {ch}\n Exp {exp+1} ')
    fsave=(f"Raw_sk&k_plots/exp{exp_id}/Raw_sk&k_LFP_exp-{exp_id}_{ch}.svg")
    fig.savefig(fsave)
    print(fsave)
    plt.close('all')
    #####################
