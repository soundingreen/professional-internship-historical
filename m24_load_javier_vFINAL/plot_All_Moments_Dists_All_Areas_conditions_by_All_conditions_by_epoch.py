# -*- coding: utf-8 -*-
"""
Created on Wed Dec  8 12:40:23 2021
...
for a in s_areas:
    ...
    for m in moments:
        ...
        fsave=(f"D:/m24_load_javier/plots/ByEpoch/{a}_conditions_Allexp/{m}/Wait_{m}_{a}_conditions_byEpoch_ALlconditions_log.svg")
        fig.savefig(fsave)
        print(fsave)
        plt.close('all')
        ...
        ax.set_xlabel('units')
        ax.set_ylabel('Probability')
        fsave=(f"D:/m24_load_javier/plots/ByEpoch/{a}_conditions_Allexp/{m}/Delay1_{m}_{a}_conditions_byEpoch_ALlconditions_log.svg")
        fig.savefig(fsave)
        print(fsave)
        plt.close('all')
        ...
        ax.set_xlabel('units')
        ax.set_ylabel('Probability')
        fsave=(f"D:/m24_load_javier/plots/ByEpoch/{a}_conditions_Allexp/{m}/Delay2_{m}_{a}_conditions_byEpoch_ALlconditions_log.svg")
        fig.savefig(fsave)
        print(fsave)
        plt.close('all')
