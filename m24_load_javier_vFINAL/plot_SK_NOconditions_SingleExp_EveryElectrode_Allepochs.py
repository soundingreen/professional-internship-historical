# -*- coding: utf-8 -*-
"""
Created on Tue Dec  7 12:40:42 2021
...
for ch in electrodes[1]:
    directory=actual+f"/SK_No_conditions_plots/exp{exp_id}/All_epochs"
    print(directory)
    try:
    ...
    fsave=(f"SK_No_conditions_plots/exp{exp_id}/All_epochs/SingleCh_SK_No_conditions_Allepochs_{ch}.svg")
    fig.savefig(fsave)
    print(fsave)
    plt.close('all')
