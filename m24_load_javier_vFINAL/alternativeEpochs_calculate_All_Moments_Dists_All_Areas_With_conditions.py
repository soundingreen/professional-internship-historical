# -*- coding: utf-8 -*-
"""
Created on Wed Dec  8 16:59:29 2021
    ...
    for exp in range(nexp):
        ...
        for i in range(len(conditions)):
            ...
            if list(lfp_areas.keys())!=[]:
                ...
                rfsave=f'D:/m24_load_javier/alternatives/Data/{a}_Conditions_Dist/{condiciones[i]}/RAW/RAW_exp_{exp:03}_samples'
                ...
                mfsave=f'D:/m24_load_javier/alternatives/Data/{a}_Conditions_Dist/{condiciones[i]}/MEAN/MEAN_exp_{exp:03}_samples'
                ...
                sfsave=f'D:/m24_load_javier/alternatives/Data/{a}_Conditions_Dist/{condiciones[i]}/STD/STD_exp_{exp:03}_samples'
                ...
                kfsave=f'D:/m24_load_javier/alternatives/Data/{a}_Conditions_Dist/{condiciones[i]}/KUR/KUR_exp_{exp:03}_samples'
                ...
                skfsave=f'D:/m24_load_javier/alternatives/Data/{a}_Conditions_Dist/{condiciones[i]}/SK/SK_exp_{exp:03}_samples'
