# -*- coding: utf-8 -*-
"""
Created on Mon Dec  6 16:08:45 2021
...
directory=actual+f"/Raw_Zscore_plots/exp{exp_id}"
print(directory)
try:
...
for ch in electrodes[1]:
    ...
    ax.set_title(f'Mean z-score of the electrode {ch}\n Exp {exp+1} ')
    fsave=(f"Raw_Zscore_plots/exp{exp_id}/Raw_Zscore_LFP_exp-{exp_id}_{ch}.svg")
    fig.savefig(fsave)
    print(fsave)
    plt.close('all')
    #####################
